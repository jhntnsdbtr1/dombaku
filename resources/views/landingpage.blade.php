...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
    ...
    <img src="img/logo/dombaku.png" alt="DombaKu Logo" class="img-fluid" style="max-height:60px; width: auto;">
    <h2 class="m-0" style="color: #0F382A;">DombaKu</h2>
    </a>
    <div class="collapse navbar-collapse" id="navbarCollapse">
    <div class="navbar-nav ms-auto p-4 p-lg-0">
        <!-- Button Login -->
        <a href="/login" class="btn rounded-pill px-4 py-2" style="background-color: #0F382A; color: white;">Login</a>
    </div>
</div>
    ...
    <div class="container-fluid px-0 mb-5">
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <img class="w-100" src="{{ asset('page/img/carousel-1.jpg') }}" alt="Image">
                ...
                <img class="w-100" src="{{ asset('page/img/carousel-2.jpg') }}" alt="Image">
                <div class="carousel-caption">
                        <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="row g-2">
                        ...
                        <div class="col-6 wow fadeIn" data-wow-delay="0.1s">
                            <img class="img-fluid rounded" src="{{ asset('page/img/service-1.jpg') }}">
                        </div>
                        <div class="col-6 wow fadeIn" data-wow-delay="0.3s">
                            <img class="img-fluid rounded" src="{{ asset('page/img/service-2.jpg') }}">
                        </div>
                        <div class="col-6 wow fadeIn" data-wow-delay="0.5s">
                            <img class="img-fluid rounded" src="{{ asset('page/img/service-3.jpg') }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-0">
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s">
                            <div class="text-center bg-primary py-5 px-4">
                                <img class="img-fluid mb-4" src="{{ asset('page/img/experience.png') }}" alt="">
                        ...
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                            <div class="text-center bg-secondary py-5 px-4">
                                <img class="img-fluid mb-4" src="{{ asset('page/img/award.png') }}" alt="">
                        ...
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.5s">
                            <div class="text-center bg-secondary py-5 px-4">
                                <img class="img-fluid mb-4" src="{{ asset('page/img/animal.png') }}" alt="">
                        ...
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.7s">
                            <div class="text-center bg-primary py-5 px-4">
                                <img class="img-fluid mb-4" src="{{ asset('page/img/client.png') }}" alt="">
...
<!-- Features End -->
    ...
    <!-- Banner Start -->
<div class="container-fluid banner my-5 py-5" data-parallax="scroll" data-image-src="{{ asset('page/img/banner.jpg') }}">
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                <div class="row g-4 align-items-center">
                    <div class="col-sm-4">
                        <img class="img-fluid rounded" src="{{ asset('page/img/banner-1.jpg') }}" alt="">
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                <div class="row g-4 align-items-center">
                    <div class="col-sm-4">
                        <img class="img-fluid rounded" src="{{ asset('page/img/banner-2.jpg') }}" alt="">
                    </div>
                    <div class="col-sm-8">
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item rounded p-4">
                    <img class="img-fluid rounded mb-4" src="{{ asset('page/img/team-1.jpg') }}" alt="">
                    <h5>Adam Crew</h5>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item rounded p-4">
                    <img class="img-fluid rounded mb-4" src="{{ asset('page/img/team-2.jpg') }}" alt="">
                    <h5>Doris Jordan</h5>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item rounded p-4">
                    <img class="img-fluid rounded mb-4" src="{{ asset('page/img/team-3.jpg') }}" alt="">
                    <h5>Jack Dawson</h5>
