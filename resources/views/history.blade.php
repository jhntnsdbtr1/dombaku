            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Manajemen Riwayat Domba</h1>
                        <ol class="breadcrumb">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form method="GET" action="{{ route('riwayat.index') }}">
                                        <div class="form-row">
                                            <div class="col-9">
                                                <input type="text" class="form-control" name="eartag" placeholder="Masukkan Eartag Domba" value="{{ request()->input('eartag') }}">
                                            </div>
                                            <div class="col-3">
                                ...
                                <div class="table-responsive p-3">
                                    <table class="table table-hover text-center" id="dataTableHover">
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                            <tr>
                                                <td colspan="4">Belum ada riwayat untuk Eartag ini.</td>
                                            </tr>
                                            @endif
                                        </tbody>
                                    </table>
