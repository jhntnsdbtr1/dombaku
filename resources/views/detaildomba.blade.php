                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="text-primary">Foto</h5>
                                    <img src="{{ asset('storage/' . $domba['foto']) }}" alt="Foto Domba" class="img-fluid rounded" style="max-width: 300px;">

                                    <h5 class="text-primary mt-4">Orang Tua</h5>
                                    ...
                                    <h5 class="text-primary mt-4">Saudara</h5>
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>Eartag</th>
